...
//   return (
//     <div className='flex justify-between items-center py-5 px-[10%] text-[#ddd] border-b-2 border-[#3c3c3c]'> {/* navbar */}
//         <img className='width: max(12vw, 120px)' src={logo} alt="" /> {/* logo */}
//         <ul className='flex gap-8 list-none'>
//             <li className='cp'>Home</li>
...
//             <select onChange={currencyHandler} className='py-1 px-2 rounded-sm bg-transparent text-white'>
